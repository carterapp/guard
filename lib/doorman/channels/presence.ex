defmodule Doorman.Presence do
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Doorman.MyChannel do
        use DoormanWeb, :channel
        alias Doorman.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :doorman,
                        pubsub_server: Doorman.PubSub
end
